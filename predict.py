...
class Recognition:
    def __init__(self, utility):
        ...
        try:
            ...
            self.nb_train_samples = int(config['Recognition']['train_samples'])
            self.nb_val_samples = int(config['Recognition']['test_samples'])
            ...
            # Image information (x:32pic, y:32pic, channel:3)
